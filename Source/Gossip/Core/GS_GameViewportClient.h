...
#include "GS_GameViewportClient.generated.h"

/**
 * 
 */
UCLASS()
class GOSSIP_API UGS_GameViewportClient : public UGameViewportClient
{
	GENERATED_BODY()
public:
...
private:
	...
	uint32 bFading : 1;
	uint32 bThisToBlack : 1; // Fading to black will be applied even if alpha is 1
	float FadeAlpha;
	float FadeStartTime;
	float FadeDuration;
};
